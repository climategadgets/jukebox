package com.homeclimatecontrol.jukebox.datastream.logger.impl.udp.xpl;

import java.util.Set;

import com.homeclimatecontrol.jukebox.datastream.logger.impl.udp.UdpLogger;
...
public class XplLogger<E extends Number> extends UdpLogger<E> {
     ...
     */
    @Override
    protected final void writeData(StringBuilder sb, String signature,
	    DataSample<E> value) {
